...
print("==============================")
print("Wissensdatenbank Version 6.5.5")
print("==============================")
...
while befehl != "exit":
    ...
    # Aufgabe 6.5.4
        ...
        stichwort = input("Zu löschendes Stichwort: ")

        if stichwort in wissensdatenbank:
            del wissensdatenbank[stichwort]

            print("Der Eintrag zum Stichwort '" + stichwort + "' wurde erfolgreich gelöscht!")
            
        else:
            print("Der Eintrag zum Stichwort '" + stichwort + "' existiert nicht!")
    ...
    # Aufgabe 6.5.5
        ...
        if stichwort in wissensdatenbank:
            beschreibung = wissensdatenbank[stichwort]
